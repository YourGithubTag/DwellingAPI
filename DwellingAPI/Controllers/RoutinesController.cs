...
namespace DwellingAPI.Controllers
{
    ...
    public class RoutinesController : ControllerBase
    {
        ...
        public RoutinesController(DwellContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Routines>> PostRoutines(Routines routines)
        {
            ...
            {
                if (RoutinesExists(routines.RoutineId))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetRoutines", new { id = routines.RoutineId }, routines);
        }
